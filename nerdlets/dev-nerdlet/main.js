...
import { Grid, GridItem, Stack, StackItem, FunnelChart, ChartGroup, BillboardChart, AreaChart, BarChart, LineChart, TableChart, PieChart, Button, TextField, Modal, Toast } from 'nr1';
                ...
                <Grid className="grid">
                    ...
                    <GridItem
                        ...
                        <Stack
                            ...
                            <StackItem>
                                <h4>CPU %</h4>
                                <LineChart accountId={this.accountId} query={infra_query + since} />
                            </StackItem>
                        </Stack>
                    </GridItem>
                    <GridItem columnSpan={6}>
                        <Stack
                            ...
                            <StackItem>
                                <h4>Load Average </h4>
                                <BillboardChart 
                                 accountId={this.accountId} query={infra_query_load + since}/>
                            </StackItem>
                            <StackItem>
                                <h4>Memory % </h4>
                                <LineChart 
                                 accountId={this.accountId} query={infra_query_mem + since}/>
                            </StackItem>
